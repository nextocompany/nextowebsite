    ...
    <>
      <header className="bg-white">
        <div className="px-4 h-14 flex items-center gap-3">
          ...
          <a
            href="/#contact"
            className="hidden md:inline-flex items-center rounded-full border border-neutral-200 px-4 py-1.5 text-xl text-neutral-600 hover:text-brand-teal-dark hover:border-brand-teal/40 transition-colors duration-200"
          >
            Connect
          </a>
